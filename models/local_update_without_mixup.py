...
import os
class LocalUpdateWithoutMixup(object):
    ...
    def train(self, net):
        ...
        for iter in range(self.args.local_ep):
            ...
            for batch_idx, (flows, labels) in enumerate(self.local_data_train):
                ...
                flows = flows + torch.randn_like(flows)
                ...
                for idx in range(flows.size()[0]):
                    ...
                    flow_self_aug = flows[idx] + torch.randn_like(flows[idx]) * self.noise_sd
                ...
                save_dir = './gradient_output_without_mixup/'
